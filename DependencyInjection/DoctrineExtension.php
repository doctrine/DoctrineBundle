...
class DoctrineExtension extends AbstractDoctrineExtension
{
     ...
     *
     * @param array<array-key,mixed> $mappingConfig
     ...
     *
     * @param array<array-key,mixed> $objectManager
     * @param ContainerBuilder       $container     A ContainerBuilder instance
     */
    protected function registerMappingDrivers($objectManager, ContainerBuilder $container)
    {
        ...
        foreach ($this->drivers as $driverType => $driverPaths) {
            ...
            if (strpos($mappingDriverDef->getClass(), 'yml') !== false || strpos($mappingDriverDef->getClass(), 'xml') !== false) {
